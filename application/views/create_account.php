...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/createAccount_style.css"/>
</head>
<body>
   ...
   <section class="createAccountbody" style="width: 100%; height: 600px; background-color: #fafafa;">
        <div class="container">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-10"><p>Create Account</p></div>
            </div>
                ...
                <div class="col-8">
                    <form action="<?php echo base_url()?>home/tambah" method="post">
                        <div class="form-group row">
                            <div class="col">
                                <input type="text" placeholder="  First name" class="input" name="nama_depan">
                            </div>
                            <div class="col">
                                <input type="text" placeholder="  Last name" class="input" name="nama_belakang">
                            </div>
                        </div>
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary" style="background-color: black; border: black; float:left;">Tambah Data</button>
                        <div class="return"><a href="<?php echo base_url()?>home">RETURN TO STORE</a></div>
                    </form>
                </div>
                <div class="col-2"></div>
            </div>
