						...
						<div class="page-width">
						    <div class="grid text-center">
						      <div class="gridtengah">
						        <header class="head">
						          <h1 class="header-title">Apparel</h1>
									...
									<div class="filter-menu">
										<div class="filter-group">
										        ...
										        <ul class="nav-price ">
										        	<li class="collection-container">
										                ...
										                <div class="collection-name" ><a href="">&#9746; Under Rp200,000</a></div>
										        ...
										        <ul class="nav-color ">
										        	<li class="collection-container">
										                ...
										                <div class="collection-name"><a href="#"><i class="icon-biru"></i> Black</a></div>
										            </li><li class="collection-container">
                                        ...
                                        <div class="grid-container">
                                              <div class="container-sepatu">
                                                  <img src="assets/bajublack.png">
                                                  <h3 class="namasepatu">Logotype Basic tee All Black</h3>
                                                  <h4 class="hargasepatu">Dropping Soon</h4>
                                                </div>
                                              <div class="container-sepatu">
                                                  <img src="assets/hoodiewhite.png">
                                                  <h3 class="namasepatu">HD-01 Logo Basic Broken White</h3>
                                                  <h4 class="hargasepatu">Dropping Soon</h4>
                                                </div>
                                              <div class="container-sepatu">
                                                  <img src="assets/hoodieblack.png">
                                                  <h3 class="namasepatu">HD-01 Logo Basic Broken Black</h3>
                                                  <h4 class="hargasepatu">Dropping Soon</h4>
                                            </div>  
