...
<body>
    <section class="headersearch" id="headersearch" style="width: 100%; height: 600px">
        <div class="tag" style="height: 400px;">
            <p>Search our site</p>
        </div>
        <div class="container carix">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                    <form method="post" action="" class="searchh" >
                        <div><input type="text" name="search" placeholder="Search"><div class="underline"></div></div>
                        <div class="tombol">
                            <button type="submit" class="btn--newsletter__submit">Search</button>
                        </div>
                    </form>
                </div>
                <div class="col-4"></div>
        ...
        <div id="navbar" class="container-fluid menux" >
            <div class="row">
                <div class="col-4">
                    <a href="#home">
