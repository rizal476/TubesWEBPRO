						...
						<div class="page-width">
						    <div class="grid text-center">
						      <div class="gridtengah">
						        <header class="head">
						          <h1 class="header-title">Sneakers Series (SN)</h1>
						            <div class="deskripsi-header">
						              <div>SN Series adalah serial sneaker dan merupakan seri perdana yang dikeluarkan oleh tim NAH Project. Cari sneakers casual favorit kamu </div>
									<div></div>
									<div>dengan harga terjangkau di sini.</div>
									...
									<div class="filter-menu">
										<div class="filter-group">
										        ...
										        <ul class="nav-size">
										        	...
										        	<li class="collection-container">
										                <div class="collection-name"><a href="">39</a></div>
										            </li><li class="collection-container">
										                <div class="collection-name"><a href="">40</a></div>
										            </li><li class="collection-container">
										        ...
										        <ul class="nav-color ">
										        	<li class="collection-container">
                                                        ...
                                                        <div class="collection-name"><a href="#"><i class="icon-gray"></i> White</a></div>
										            </li>
                                                    </ul>
										        </div></div>
										        <div class="filter-group">
										        ...
										        <ul class="nav-collections">
										            <li class="collection-container">
										                <div class="collection-name">
										                    <a href="#" title="YAS"></i>&#9746; Sneakers Series (SN)</a>
										                </div>
										            </li>
										        </ul>
										      </div>
                                        ...
                                        <div class="grid-container">
                                              <div class="container-sepatu">
                                                  <img src="assets/white.png">
                                                  <h3 class="namasepatu">SN-05R Monochrome White</h3>
                                                  <h4 class="hargasepatu">Rp.320.000</h4>
                                                </div>
                                              <div class="container-sepatu">
                                                  <img src="assets/black.png">
                                                  <h3 class="namasepatu">SN-05R Monochrome Black</h3>
                                                  <h4 class="hargasepatu">Rp.320.000</h4>
                                                </div>
                                              <div class="container-sepatu">
                                                  <img src="assets/maroon.png">
                                                  <h3 class="namasepatu">SN-05 Revived Suede Maroon</h3>
                                                  <h4 class="hargasepatu">Rp.320.000</h4>
                                            </div>  
                                              <div class="container-sepatu">
                                                  <img src="assets/olive.png">
                                                  <h3 class="namasepatu">SN-05 Revived Suede Olive</h3>
                                                  <h4 class="hargasepatu">Rp.320.000</h4>
                                            </div>
                                              <div class="container-sepatu">
                                                  <img src="assets/indigo.png">
                                                  <h3 class="namasepatu">SN-05 Revived Suede Indigo</h3>
                                                  <h4 class="hargasepatu">Rp.320.000</h4>
                                            </div>
                                              <div class="container-sepatu"><img src="assets/blackwhite.png">
                                              <h3 class="namasepatu">SN-04 Black White</h3>
                                                  <h4 class="hargasepatu">Dropping Soon</h4>
                                            </div>
                                            <div class="container-sepatu">
                                                  <img src="assets/allwhite.png">
                                                  <h3 class="namasepatu">SN-04 All White</h3>
                                                  <h4 class="hargasepatu">Dropping Soon</h4>
                                            </div>
                                        </div>
