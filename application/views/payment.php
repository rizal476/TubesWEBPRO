...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/confirm_style.css"/>
</head>
<body>
    <section class="paymentbody" style="width: 100%; height: 600px; background-color: #fafafa;">
        <div class="container">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-10"><p>Confirm Payment</p></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <form method="post" action="" class="form1">
                            <input type="text" placeholder="  Payment ID" class="input">
                    </form>
                </div>
                <div class="col-2"></div>
            </div>
            ...
            <div class="row">
                <div class="col-2"></div>
                <div class="col-8">
                        <div class="column confirm"><a href="">CONFIRM</a></div> 
                </div>
                <div class="col-2"></div>
            </div>
        </div>
