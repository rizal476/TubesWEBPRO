...
<body>
    <section class="loginbody" style="width: 100%; height: 600px; background-color: #fafafa;">
        <div class="container">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-10"><p>Login</p></div>
            </div>

            <div class="row">
                <div class="col-2"></div>
                <div class="col-8">
                    <form method="post" action="<?php echo base_url()?>home/aksiLogin" class="form1">
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary" style="background-color: black; border: black; float:left;">SIGN IN</button>
                        <div class="column createaccount"><a href="<?php echo base_url()?>home/createAccount">CREATE ACCOUNT</a></div>
                        <div class="column forgot"><a href="<?php echo base_url()?>home/forgotPass">FORGOT YOUR PASSWORD?</a></div>
                    </form>
                </div>
                <div class="col-2"></div>
            </div>
